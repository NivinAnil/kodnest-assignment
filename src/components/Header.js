        ...
        <div className='sticky top-0 '>
            <div className='w-screen flex  bg-blue-400 p-5  z-20'>
                <div className='uppercase flex flex-row flex-1 text-xl text-white font-bold'>
                    <div>KodNest</div>
                    {/* {isLoggedIn ? <div className='w-min mx-10 p-2 text-sm text-white font-bold cursor-pointer rounded-xl hover:shadow-md hover:bg-blue-200 hover:text-gray-500'
                        onClick={() => navigate(HandleRoutes.HOME)}
                    >home</div> : <></>} */}
                    {isLoggedIn ? <div className='w-min mx-10 p-2 text-sm text-white font-bold cursor-pointer rounded-xl hover:shadow-md hover:bg-blue-200 hover:text-gray-500'
                        onClick={() => navigate(HandleRoutes.DASHBOARD)}
                    >Dashboard</div> : <></>}
                </div>
